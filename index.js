...
`\n\nIf you have existing balance, you can tip others by replying to a post/comment by them with \`!pivxtip [amount]\`. My code is fully open source! You can review it at http://tip.pivx.events . Have fun!`;
